...
impl ConfigurationView {
    ...
    fn render_instructions(cx: &App) -> Div {
        v_flex()
            ...
            .child(
                Label::new(
                    "使用 llama.cpp 内置服务器在本地运行开放模型，或连接到远程 llama.cpp 服务器。",
                )
                .color(Color::Muted),
            )
            ...
            .child(
                List::new()
                    .child(
                        ListBulletItem::new("")
                            .child(Label::new("从以下地址安装 llama.cpp").color(Color::Muted))
            ...
            .child(
                Label::new(
                    "也可以指定 URL 和 API 密钥（通过 --api-key 设置，可能非必需）来连接到远程 llama.cpp 服务器：",
                )
                .color(Color::Muted),
            )
    }
                    ...
                    .child(
                        h_flex()
                            ...
                            .map(|this| {
                                if is_authenticated {
                                    this.child(
                                        Button::new("llama-cpp-webui", "打开 WebUI")
                                    ...
                                    this.child(
                                        Button::new("download_llama_cpp_button", "获取 llama.cpp")
                                            .style(ButtonStyle::OutlinedGhost)
                                            .size(ButtonSize::Medium)
                                            .end_icon(
                                                Icon::new(IconName::ArrowUpRight)
                            ...
                            .child(
                                Button::new("view-models", "浏览 GGUF 模型")
                                    .style(ButtonStyle::OutlinedGhost)
                                    .size(ButtonSize::Medium)
                                    .end_icon(
                                        Icon::new(IconName::ArrowUpRight)
