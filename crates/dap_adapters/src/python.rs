            ...
            .get_or_init(|| async {
                let base_python = if let Some(toolchain) = toolchain {
                    ...
                    Self::system_python_name(delegate).await.ok_or_else(|| {
                        ...
                        if cfg!(windows){
                            message.push_str("。请从 Microsoft Store 安装 Python，或访问 https://www.python.org/downloads/windows 手动安装。")
                        }
                        message
                    })?
                };
    ...
    fn dap_schema(&self) -> serde_json::Value {
        json!({
            "properties": {
                ...
                "autoReload": {
                    ...
                    "properties": {
                        ...
                        "exclude": {
                            ...
                            "description": "要从自动重新加载中排除的路径 glob 模式。",
                            "items": {
                                "type": "string"
                            },
                            "type": "array"
                ...
                "justMyCode": {
                    "default": true,
                    "description": "若为 true，只显示和调试用户编写的代码。若为 false，显示和调试所有代码，包括库调用。",
                    "type": "boolean"
                },
                "logToFile": {
                    "default": false,
                    "description": "将调试器事件记录到日志文件。该文件位于 debugpy 扩展安装文件夹中。",
                    "type": "boolean"
                },
                "pathMappings": {
                    "default": [],
                                ...
                                "anyOf": [
                                    {
                                        ...
                                        "description": "使用进程选择器选择要附加的进程，或整数形式的进程 ID。",
                                        "enum": [
                                            "${command:pickProcess}"
                                        ]
                                    },
                                    {
                                        "description": "要附加的本地进程 ID。",
                                        "type": "integer"
                                    }
                                ]
                            }
                ...
                },
                {
                    ...
                    "then": {
                        "properties": {
                            "args": {
                                "default": [],
                                "description": "传递给程序的命令行参数。对于字符串类型参数，会原样通过 shell 传递，因此所有 shell 变量展开都会生效。但对于数组类型，其值会经过 shell 转义。",
                                "items": {
                                    "type": "string"
                                },
                                "anyOf": [
                            ...
                            "console": {
                                ...
                                "description": "调试目标的启动位置：内部控制台、集成终端或外部终端。",
                                "enum": [
                                    "externalTerminal",
                                    "integratedTerminal",
                                    "internalConsole"
                            ...
                            "cwd": {
                                "default": "${ZED_WORKTREE_ROOT}",
                                "description": "被调试程序工作目录的绝对路径。默认为文件所在根目录（留空）。",
                                "type": "string"
                            },
                            "autoStartBrowser": {
                                "default": false,
                                "description": "打开外部浏览器以启动应用",
                                "type": "boolean"
                            },
                            "env": {
                                ...
                                "default": {},
                                "description": "以键值对形式定义的环境变量。属性名即环境变量名，属性值即该环境变量的值。",
                                "type": "object"
                            },
                            "envFile": {
                            ...
                            "gevent": {
                                "default": false,
                                "description": "启用 gevent monkey patch 代码的调试。",
                                "type": "boolean"
                            },
                            "module": {
                                "default": "",
                                "description": "要调试的模块名称。",
                                "type": "string"
                            },
                            "program": {
                                "default": "${ZED_FILE}",
                            ...
                            "pyramid": {
                                "default": false,
                                "description": "是否调试 Pyramid 应用。",
                                "type": "boolean"
                            },
                            "python": {
                                "default": "${command:python.interpreterPath}",
                                "description": "Python 解释器可执行文件的绝对路径；若设置则覆盖工作区配置。",
                                "type": "string"
                            },
                            "pythonArgs": {
                                "default": [],
                            ...
                            "guiEventLoop": {
                                "default": "matplotlib",
                                "description": "将要运行的 GUI 事件循环。可能的值：\"matplotlib\"、\"wx\"、\"qt\"、\"none\"，或一个会被导入并运行的自定义函数。",
                                "type": "string"
                            }
                        }
                    }
